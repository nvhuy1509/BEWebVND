...
$('.slider-nav').slick({
    ...
    dots: false,
    arrows: true,
    prevArrow: '<img src="../../images/PC_blog/slide-prev-black.svg" class="slick-prev" id="btnPrev" onclick="onActiveBtnSlick(this)" >',
    nextArrow: '<img src="../../images/PC_blog/slide-next-black.svg" class="slick-next" id="btnNext" onclick="onActiveBtnSlick(this)" >',
